...
//	below is forcing to kick in circuit breaker only after 4 seconds
//	this was defined in order to retry pattern inside accounts microservice
//	because circuit breaker was kicking in before actually retry pattern completeing its lifecycle
	@Bean
